const { tema_luxuri } = require('../models');
...
exports.CreateInvitation = async (req, res, next) => {
  ...
  try {
    const uploadDataInvitation = await tema_luxuri.create({
...
exports.getDataInvitation = async (req, res, next) => {
  ...
  const findDataById = await tema_luxuri.findOne({
...
exports.updateDataInvitation = async (req, res, next) => {
  ...
  const findDataInvitation = await tema_luxuri.findOne({
    where: { id: paramsId.id },
  });
  ...
  try {
    const updateDataInvitation = await tema_luxuri.update(
      {
        id_user: insertData.id_user,
        m_nama: insertData.m_nama,
        m_panggilan: insertData.m_panggilan,
